 ...
 */
abstract contract InterledgerSenderInterface {
     ...
     */
    function interledgerCommit(uint256 id) public virtual;
     ...
     */
    function interledgerCommit(uint256 id, bytes memory data) public virtual;
     ...
     */
    function interledgerAbort(uint256 id, uint256 reason) public virtual;
}
